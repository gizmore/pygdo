...
bash gdo_adm.sh install irc,telegram,pm,markdown,blackjack,account,admin,contact,perf,math,login,register,recovery,bootstrap5,avatar,shadowdogs,vote,poll,quote,scum,slapwarz,websocket,discord,connect
