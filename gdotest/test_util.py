...
class UtilityTestCase(GDOTestCase):
    ...
    async def test_array_walk(self):
    ...
    async def test_chunky_strings(self):
        maxlen = 32
    ...
    async def test_regex_first(self):
