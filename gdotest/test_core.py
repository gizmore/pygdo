...
class CoreTestCase(GDOTestCase):
    ...
    async def test_04_float_rendering(self):
    ...
    async def test_06_permutations(self):
        values = [[1, 2], [3], [4, 5, 6]]
        correct = [
            [1, 3, 4],
            [2, 3, 4],
    ...
    async def test_08_gdt_user(self):
        gdt = GDT_User('test')
        user = gdt.to_value('1')
    ...
    async def test_09_db_debug(self):
    ...
    async def test_15_cache_efficiency(self):
