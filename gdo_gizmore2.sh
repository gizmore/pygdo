...
bash gdo_adm.sh install account,admin,avatar,blackjack,bootstrap5,chess,chatgpt4o,choices,cities,clock,connect,contact,favicon,fun,gogol,icon_fa,irc,login,maps,markdown,math,online,perf,pm,poll,quote,register,scum,shadowdogs,slapwarz,usertitle,vote,websocket,wechall,zen
