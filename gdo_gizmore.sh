...
bash gdo_adm.sh install irc,chatgpt4o,telegram,pm,markdown,blackjack,account,admin,contact,perf,math,login,register,bootstrap5,avatar,shadowdogs,vote,poll,chess,quote,scum,slapwarz,gogol,websocket,telegram,discord,wechall,poll
